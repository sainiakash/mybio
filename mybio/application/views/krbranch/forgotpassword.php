       ...
       <div class="logo-top">
        ...
        <div class="animate form login_form">
          ...
          <section class="login_content">
            <form method="POST" action="<?php echo base_url('branch/sendotp'); ?>">
              <div>
              ...
              <div style="width: 100%; text-align: center;">
                <input type="submit" class="btn btn-default submit" value="Submit" name="forgot" style="background-color: transparent; color: #73879c; float: none; margin: 0px; border: 1px solid gray;"><br>
              </div>
