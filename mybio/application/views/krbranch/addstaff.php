                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" novalidate="" action="<?php echo base_url('branch-add-staff'); ?>">
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">직원 ID
                        <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" class="form-control" placeholder="직원 ID" name="staff_id" value="<?php echo set_value('staff_id'); ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  class="form-control" placeholder="위치" name="position" value="<?php echo set_value('position'); ?>">
                           <div class="text text-danger">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">도
                        <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  class="form-control" placeholder="도" name="degree" value="<?php echo set_value('degree'); ?>">
                           <div class="text text-danger">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  class="form-control" placeholder="경험" name="experience" value="<?php echo set_value('experience'); ?>">
                           <div class="text text-danger">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  class="form-control" placeholder="주민등록번호" name="ssn" value="<?php echo set_value('ssn'); ?>">
                           <div class="text text-danger">
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          ...
                          <input type="submit" class="btn btn-success" name="addstaff" value="제출하다">
                        </div>
                      </div>
                    </form>
                  </div>
