            ...
            <div class="product-view-box">
              <div class="product-img-boxes text-center">
                <div class="product-imgs">
                  ...
                  {
                  ?>
                      <img src="<?php echo base_url('public/product/').$product->p_image; ?>" alt="">
                  <?php
                  }
                  ?>
            ...
            <div class="product-details-box">
              <div class="box-list-box">
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_name; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->c_name; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_sku_code; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_price; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_mrp; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_quantity; ?>
                    </p>
                  </div>
                </div>
                <div class="box-list">
                  ...
                  <div>
                    <p class="m-0"><?php echo $product->p_slug; ?>
                    </p>
                  </div>
                </div>
              </div>
