          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 ">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" method="POST" novalidate="" action="<?php echo base_url('addlocation'); ?>" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" value="<?php echo set_value('country'); ?>" class="form-control" placeholder="Country" name="country">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="state" class="form-control" placeholder="State" value="<?php echo set_value('state'); ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="postalcode" class="form-control" placeholder="Postalcode" value="<?php echo set_value('postalcode'); ?>">
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          ...
                          <input type="submit" class="btn btn-success" name="addlocation" value="Submit">
                        </div>
                      </div>
                    </form>
                  </div>
