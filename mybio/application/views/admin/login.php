...
<html lang="en" >
  <head>
    ...
    <title>MyBio21 | Admin Panel</title>
    <!-- Bootstrap -->
          ...
          <section class="login_content">
            <form method="POST" action="<?php echo base_url('login'); ?>">
              ...
              <div style="width: 100%; text-align: center;">
                <input type="submit" class="btn btn-default submit" value="Log in" name="login" style="background-color: transparent; color: #73879c; float: none; margin: 0px; border: 1px solid gray;">
