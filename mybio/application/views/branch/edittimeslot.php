      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
             <div class="row">
              ...
              <div class="x_content">
                <br>
                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" novalidate="" action="<?php echo base_url('branch-update-timeslot/').$timeslot->ts_id; ?>">
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <select class="form-control" name="language">
                        <option value="" selected disabled><?php echo $timeslot->ts_language; ?></option>
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <div class='input-group date' id='datetimepicker1'>
                        <select class="form-control mr-3" name="start_day">
                          <option disabled selected value=""><?php echo $timeslot->ts_start_day; ?>
                          </option>
                        ...
                        <input type='text' class="form-control" name="start_time" value="<?php echo $timeslot->ts_start_time; ?>">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                      <div class='input-group date' id='datetimepicker2'>
                        <select class="form-control mr-3" name="end_day">
                          <option disabled selected value=""><?php echo $timeslot->ts_end_day; ?>
                          </option>
                          <option value="Sun">Sunday
                          </option>
                          <option value="Mon">Monday
                        ...
                        <input type='text' class="form-control" name="end_time" value="<?php echo $timeslot->ts_end_time; ?>">
                        <span class="input-group-addon">
                          <span class="fas fa-clock pt-1">
                          </span>
                        </span>
                  ...
                  <div class="item form-group">
                    <div class="col-md-6 col-sm-6 offset-md-3">
                        ...
                        <input type="submit" class="btn btn-success" name="updatetimeslot" value="Submit">
                    </div>
                  </div>
                </form>
              </div>
