      ...
      <div class="row mt-5">
        ...
        ?>
          ...
          <div class="test-box">
            ...
            <h5><?php echo $values['t_name']; ?></h5>
            <p>Include : 10 Parameters</p>
            <div class="test-box-list">
              <li><?php echo $values['t_description']; ?></li>
            ...
            <div class="price">
              <span><del class="text-muted"><?php echo $values['t_mrp']; ?></del></span>
              <span class="price-green"><?php echo $values['t_price']; ?></span>
            </div>
     ...
     <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
       <div class="newsletter-box text-center">
         <div class="newsletter-content ">
          ...
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aperiam rerum, ratione dolore sunt obcaecati et dolores culpa aliquid commodi? Quasi.</p>
         </div>
