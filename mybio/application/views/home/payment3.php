      ...
      <div class="check-out-box">
        ...
        <div class="check-out-heading-black d-flex align-items-center mt-3">
          ...
          <div class="check-out-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="address-click-box">
                      <div class="row">
                          <div class="col-md-10">
                            <div class="address-save">
                                <a href="payment4.html">
                                    <p class="m-0">Alex Smit <br> New City USA 1196, <br>Male, 25</p>
                                </a>
                            </div>
                          </div>
                ...
                <div class="col-md-6">
                    <div class="view-save-add-box">
                        <div class="view-save-add">
                            <a href="">View Saved Address</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-3">
                    <div class="continue">
                        <a href="payment4.html">Continue</a>
                    </div>
                </div>
            </div>
          </div>
