...
<div class="other-page">
  <div class="other-heading text-center text-white">
    <h1>Create Verification Code
    </h1>
    <p>Home / Create Verification Code
    </p>
  </div>
</div>
</div>
    ...
    <div class="container padding">
      <div class="row ">
        ...
        <div class="col-md-7 col-lg-7">
          <h4 class="text-left ">Create Verification Code
          </h4>
          <hr class="green-hr">
          <?php
          ...
          ?>
          <div class="col-lg-12 col-md-12 box2">
            <form action="<?php echo base_url('user-create-verification-code-post/').$profile->u_id; ?>" method="POST">
              ...
              <div class="sign-btn" >
                <input type="submit" name="createcode" value="Create Code" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
